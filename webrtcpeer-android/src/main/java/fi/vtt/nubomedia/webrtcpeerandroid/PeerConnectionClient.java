...
//m	public static final String VIDEO_TRACK_ID = "ARDAMSv0";
//m	public static final String AUDIO_TRACK_ID = "ARDAMSa0";
...
//m	private static final String VIDEO_CODEC_PARAM_START_BITRATE = "x-google-start-bitrate";
//m	private static final String AUDIO_CODEC_PARAM_BITRATE = "maxaveragebitrate";
...
//m	private final PCObserver pcObserver = new PCObserver();
//	private final SDPObserver sdpObserver = new SDPObserver();
	private final LooperExecutor executor;
	private PeerConnectionFactory factory;
	private PeerConnection peerConnection;
	PeerConnectionFactory.Options options = null;
//m	private VideoSource videoSource;
//m	private boolean videoCallEnabled;
//m	private boolean preferIsac;
//m	private boolean preferH264;
//m	private boolean videoSourceStopped;
	private boolean isError;
	private Timer statsTimer;
//m	private VideoRenderer.Callbacks localRender;
//m	private VideoRenderer.Callbacks remoteRender;
...
//m	private LinkedList<IceCandidate> queuedRemoteCandidates;
	private PeerConnectionEvents events;
	private boolean isInitiator;
//m	private SessionDescription localSdp; // either offer or answer SDP
	private MediaStream mediaStream;
//m	private int numberOfCameras;
//m	private VideoCapturerAndroid videoCapturer;
	// enableVideo is set to true if video should be rendered and sent.
//m	private boolean renderVideo;
//m	private VideoTrack localVideoTrack;
...
//	 */
//	public void createPeerConnection(final EGLContext renderEGLContext, final VideoRenderer.Callbacks localRender, final VideoRenderer.Callbacks remoteRender, final SignalingParameters signalingParameters) {
...
//		if (videoCallEnabled && peerConnectionParameters.videoCodec != null && peerConnectionParameters.videoCodec.equals(VIDEO_CODEC_VP9)) {
//			field_trials += FIELD_TRIAL_VP9;
//		}
//		PeerConnectionFactory.initializeFieldTrials(field_trials);
//		// Check if H.264 is used by default.
//		preferH264 = false;
//		if (videoCallEnabled && peerConnectionParameters.videoCodec != null && peerConnectionParameters.videoCodec.equals(VIDEO_CODEC_H264)) {
//			preferH264 = true;
//		}
...
//			Log.e(TAG, "Failed to switch camera. Video: " + videoCallEnabled + ". Error : " + isError + ". Number of cameras: " + numberOfCameras);
